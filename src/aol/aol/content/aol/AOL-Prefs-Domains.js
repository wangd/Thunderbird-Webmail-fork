var gAOLDomain =
{
    ...
    init : function ()
    {
        try
        {
            ...
            this.m_Domains = Components.classes["@mozilla.org/AOLDomains;1"].
                             getService().
    ...
    {
        this.m_DebugLog.Write("AOL-Prefs-Domains : domainList - START " +szDomain);
    ...
    onAdd : function ()
    {
        try
        {
            ...
            this.m_DebugLog.Write("AOL-Prefs-Domains : onAdd - END");
        }
        catch(e)
        {
             this.m_DebugLog.DebugDump("AOL-Prefs-Domains : Exception in onAdd : "
                                          + e.name +
                                          ".\nError message: "
                                          + e.message + "\n"
                                          + e.lineNumber);
    ...
    onRemove  : function ()
    {
        ...
        {
            this.m_DebugLog.DebugDump("AOL-Pref-Window : Exception in doRemove : "
                                          + e.name +
                                          ".\nError message: "
                                          + e.message + "\n"
                                          + e.lineNumber);
