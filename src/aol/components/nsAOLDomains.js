...
nsAOLDomains.prototype =
{
    ...
    notify: function(timer)
    {
        try
        {
            ...
            {
                if (!this.domainCheck(aszDomain[i], "POP", "@mozilla.org/AOLPOP;1"))
                    this.domainAdd(aszDomain[i], "POP", "@mozilla.org/AOLPOP;1")
                if (!this.domainCheck(aszDomain[i], "SMTP", "@mozilla.org/AOLSMTP;1"))
                    this.domainAdd(aszDomain[i], "SMTP", "@mozilla.org/AOLSMTP;1")
            }
