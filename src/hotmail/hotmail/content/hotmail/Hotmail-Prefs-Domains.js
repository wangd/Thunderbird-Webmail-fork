var gHotmailDomain =
{
    ...
    addListItems : function ()
    {
        try
        {
            this.m_DebugLog.Write("Hotmail-Prefs-Domains : AddListItems - START");
            ...
            if (this.m_Domains.getAllDomains(iCount,aszDomains))
            {
                ...
                this.errorList();
            this.m_DebugLog.Write("Hotmail-Prefs-Domains : AddListItems - END");
        }
        catch(e)
        {
            this.m_DebugLog.DebugDump("Hotmail-Prefs-Domains : Exception in AddListItems : "
    ...
    onAdd : function ()
    {
        try
        {
            ...
            if (oResult.value!=-1)
            {
                ...
                //add item to list
                this.m_Domains.addDomain(oParam.szDomain)
