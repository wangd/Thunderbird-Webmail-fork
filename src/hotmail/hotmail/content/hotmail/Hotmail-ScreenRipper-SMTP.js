            ...
            switch (mainObject.m_iStage)
            {
                case 0: //login
                    ...
                    for (i=0; i<aInput.length; i++)
                    {
                        ...
                        mainObject.m_Log.Write("Hotmail-SR-SMTP.js - loginOnloadHandler - form value " + szValue);
            ...
            switch (mainObject.m_iStage)
            {
                ...
                case 1: //MSG OK handler
                    if (szResponse.search(patternHotmailAD)!=-1)
                    {
                        ...
                        {
                            mainObject.m_Log.Write("Hotmail-SR-SMTP.js - composerOnloadHandler - Saving Seasion data");
