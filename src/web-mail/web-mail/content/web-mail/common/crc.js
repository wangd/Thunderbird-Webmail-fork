/************************************************************************************************
  ...
  JavaScript source code        April 17, 2004
...
*/
{
  return ((crc<<8)^Crc16Tab[((crc>>8)^c)&0xFF])&0xFFFF;
}
/*
  C/C++ language:
  ...
  {
    return (unsigned short)(crc<<8)^Crc16Tab[(unsigned char)(crc>>8)^c];
  }
*/
...
*/
{
  return ((crc>>8)&0xFF)^CrcArcTab[(crc^c)&0xFF];
}
/*
  C/C++ language:
  ...
  {                                                     
    return (unsigned short)(crc>>8)^CrcArcTab[(unsigned char)crc^c];
  }
*/
