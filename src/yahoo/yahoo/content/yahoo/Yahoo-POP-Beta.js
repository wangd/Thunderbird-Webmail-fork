...
{     
    logIn : function(szUserName , szPassword)
    {
        try
        {
            ...
            {
                this.m_Log.Write("YahooPOPBETA.js - logIN - deleting Session Data");
                this.m_HttpComms.deleteSessionData(); 
    ...
    logOut : function()
    {
        try
        {
            ...
            { 
                ...
                this.m_Log.Write("YahooPOPBETA.js - logOut - szHomeURI" + this.m_szHomeURI);    
            }
            else
            {
                this.m_Log.Write("YahooPOPBETA.js - logOUT - deleting Session Data");
                this.m_HttpComms.deleteSessionData(); 
                this.m_ComponentManager.deleteAllElements(this.m_szUserName);
            }
